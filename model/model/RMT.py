...
class VisRetNet(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000,
        ...
        #     heads_range=heads_ranges[0],
        #     ffn_dim=int(mlp_ratios[0] * embed_dims[0]),
        #     drop_path=dpr[sum(depths[:0]):sum(depths[:0 + 1])],
        #     norm_layer=norm_layer,
        #     chunkwise_recurrent=chunkwise_recurrents[0],
        #     downsample=None,
        #     use_checkpoint=use_checkpoints[0],
        #     layerscale=layerscales[0],
        #     layer_init_values=layer_init_values
        # )
        #
        ...
        #     init_value=init_values[1],
        #     heads_range=heads_ranges[1],
        #     ffn_dim=int(mlp_ratios[1] * embed_dims[1]),
        #     drop_path=dpr[sum(depths[:1]):sum(depths[:1 + 1])],
        #     norm_layer=norm_layer,
        #     chunkwise_recurrent=chunkwise_recurrents[1],
        #     downsample=PatchMerging,
        #     use_checkpoint=use_checkpoints[1],
        #     layerscale=layerscales[1],
        #     layer_init_values=layer_init_values
        # )
        #
        ...
        #     init_value=init_values[2],
        #     heads_range=heads_ranges[2],
        #     ffn_dim=int(mlp_ratios[2] * embed_dims[2]),
        #     drop_path=dpr[sum(depths[:2]):sum(depths[:2 + 1])],
        #     norm_layer=norm_layer,
        #     chunkwise_recurrent=chunkwise_recurrents[2],
        #     downsample=PatchMerging,
        #     use_checkpoint=use_checkpoints[2],
        #     layerscale=layerscales[2],
        #     layer_init_values=layer_init_values
        # )
        #
        ...
        #     init_value=init_values[3],
        #     heads_range=heads_ranges[3],
        #     ffn_dim=int(mlp_ratios[3] * embed_dims[3]),
        #     drop_path=dpr[sum(depths[:3]):sum(depths[:3 + 1])],
        #     norm_layer=norm_layer,
        #     chunkwise_recurrent=chunkwise_recurrents[3],
        #     downsample=PatchMerging,
        #     use_checkpoint=use_checkpoints[3],
        #     layerscale=layerscales[3],
        #     layer_init_values=layer_init_values
        # )
...
#
# # Initialize model
# # model = RMT_T3(args=None)  # Provide necessary arguments if any
# # model = RMT_S(args=None)  # Provide necessary arguments if any
# model = RMT_modify()  # Provide necessary arguments if any
#
