...
# 指定原始图片文件夹路径
original_images_dir = r'D:\HTNet-master\HFA_Net\dataset\total_offset-apex_li'

# 指定新数据集的文件夹路径
base_dir = r'D:\HTNet-master\HFA_Net\dataset\442loso_of_ap_li'
...
for subject in df['subject'].unique():
    ...
    for _, row in subject_df.iterrows():
        img_file = row['flowimg'].replace('.jpg', '.png')  # 这里替换掉 .jpg，确保使用 .png
