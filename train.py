...
def whole_face_block_coordinates():
    df = pd.read_csv(r'D:\HTNet-master\HTNet-master\combined_3_class2_for_optical_flow.csv')
    base_data_src = r'D:\HTNet-master\HTNet-master\datasets\combined_datasets_whole'
...
def crop_optical_flow_block():
    # 其他部分保持不变
    whole_optical_flow_path = r'D:\HTNet-master\HTNet-master\datasets\STSNet_whole_norm_u_v_os'
...
def main(config):
    ...
    main_path = r'D:\HTNet-master\HTNet-master\datasets\three_norm_u_v_os'
    ...
    for n_subName in subName:#遍历主数据集下的每个子文件夹
        ...
        #kwargs = {'input_channels': 3, 'num_classes': 3}  # 设置你需要的参数
