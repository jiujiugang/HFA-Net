...
class Visformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, init_channels=3, num_classes=3, embed_dim=192, depth=6,
...
def visformer_tiny(**kwargs):
    model = Visformer(img_size=224, init_channels=3, embed_dim=192, depth=[2,2,2], num_heads=3, mlp_ratio=4., group=8,
